    ...
    const plans = [
        {
            ...
            moduleKeys: ['leads', 'followups', 'calls', 'whatsapp', 'forms', 'meetings', 'automations', 'analytics', 'tasks', 'notifications'],
            features: [
        ...
        },
        {
            ...
            price: 0,
            yearlyPrice: 0,
            moduleKeys: ['leads', 'followups', 'analytics', 'notifications'],
        ...
        },
        {
            ...
            yearlyPrice: 9990,
            perUserPrice: 199,
            moduleKeys: ['leads', 'followups', 'calls', 'forms', 'automations', 'analytics', 'notifications'],
            features: [
