...
SparkCRM is a multi-tenant CRM for lead capture, assignment, calling, WhatsApp communication, automation, analytics, billing, and owner-managed tenant configuration.

## Integration setup

See [`docs/integration-setup.md`](docs/integration-setup.md) for the complete Meta Lead Ads, WhatsApp, website API, Firebase push, mobile calling, private recording storage, payment, Chrome extension, deployment, and verification guide.
